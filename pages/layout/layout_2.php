    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                <!-- Dashboard -->
                <li class="menu-item">
                    <a href="user-resultat.html" class="menu-link">
                ...
                <li class="menu-item active open">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Account Settings">Saisie</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item active">
                            <a href="form-user-ceuillettes.html" class="menu-link">
                                <div data-i18n="Account">Cueillette</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="form-user-depenses.html" class="menu-link">
                                <div data-i18n="Notifications">Depense</div>
                            </a>
                        </li>
                    </ul>
                </li>
                                ...
                                <div class="card-body">
                                    <form action="#" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="Cueilleur"
                                                    aria-label="Default select example" name="cueilleur">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="parcelle"
                                                    aria-label="Default select example" name="parcelle">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="poids-ceuilli"
                                                   name="poids-ceuilli"/>
                                        </div>
